  ...
  return (
    <div className="whyChoose">
      ...
      <p className="text-[18px] font-bold leading-[40px] text-white text-justify mt-5">
        الوكيل المعتمد لشركة XPEL الأمريكية في المملكة العربية السعودية المتخصصة
        في منتجات حماية وتظليل السيارات بخبرة لأكثر من 16 عام وضمان يصل حتى 10
        سنوات. نقدم باستمرار أعلى مستويات الجودة والدقة في تنفيذ خدماتنا
